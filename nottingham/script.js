...
// function to setup the scene, camera, renderer, and load 3d model
   ...
   window.addEventListener( 'click', onClick, false);
    ...
    const model = 'nottingham.3dm'
  

    var objLayer = [];
    let scene, camera, renderer, controls, raycaster, gui, pointlight, ambientLight;
    ...
    function init() {
      ...
      new RGBELoader().setPath('textures/').load('chinese_garden_4k.hdr', function(hdrmap) {
        ...
        loader.load( model, function ( object ) {
          ...
          //objLayer= scene.getChildByName('building')
          ...
          //let objLayer = scene.getObjectByName( "Exisiting", true );
    ...
    */
    ...
    // calculate objects intersecting the picking ray
      ...
      const intersects = raycaster.intersectObjects(objLayer, true )
